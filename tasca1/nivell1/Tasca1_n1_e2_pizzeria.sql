...
-- FOREIGN KEY (num_begudes) REFERENCES begudes(id_beguda),
-- FOREIGN KEY (num_hamburgueses) REFERENCES hamburgueses(id_hamburguesa),
FOREIGN KEY (id_botiga) REFERENCES botigues(id_botiga),
...
INSERT INTO comandes (id_client, domicili_botiga, num_pizzes, num_begudes, num_hamburgueses, preu_total, id_botiga)
VALUES
(1, 'Domicili', 0, 1, 0, 19.7, 1),
(2, 'Botiga', 0, 2, 0, 16.1, 2),
(3, 'Domicili', 0, 1, 0, 14.2, 1),
(4, 'Botiga', 0, 0, 0, 25.5, 2),  
(5, 'Domicili', 0, 1, 0, 18.6, 1),
(6, 'Botiga', 0, 2, 0, 27.9, 2),
(7, 'Domicili', 0, 0, 1, 14.5, 1),
(8, 'Botiga', 1, 0, 0, 18.7, 2);
